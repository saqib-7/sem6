...
def respond(input: List[str]):
    ...
    if len(symptoms) == 3:
        if (
            symptoms[0] == "rash"
            and symptoms[1] == "body ache"
            and symptoms[2] == "fever"
        ):
        ...
        if (
            symptoms[0] == "headache"
            and symptoms[1] == "runny nose"
            and symptoms[2] == "sneezing"
            and symptoms[3] == "sore throat"
        ):
            ...
            symptoms[0] == "headache"
            and symptoms[1] == "abdominal pain"
            and symptoms[2] == "poor appetite"
            and symptoms[3] == "fever"
        ):
        ...
        if (
            ...
            and symptoms[1] == "fever"
            and symptoms[2] == "headache"
            and symptoms[3] == "chills"
            and symptoms[4] == "body ache"
        ):
        ...
        if (
            symptoms[0] == "fever"
            and symptoms[1] == "sweating"
            and symptoms[2] == "headache"
            and symptoms[3] == "nausea"
            and symptoms[4] == "vomiting"
            and symptoms[5] == "diahrrea"
        ):
